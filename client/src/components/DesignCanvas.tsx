...
export default function DesignCanvas() {
  ...
  return (
    <div className="h-full w-full bg-white dark:bg-technical-800 rounded-xl shadow-sm border border-technical-200 dark:border-technical-700 relative overflow-hidden main-canvas responsive-container flex-1 min-w-0">
      {/* Canvas Header */}
